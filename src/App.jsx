...
function App() {
  ...
  return (
    <>
      <header>
        <div className='w-full h-64 bg-[url(./assets/bg.svg)] bg-cover bg-center'>
        </div>
      </header>
      <main>
        ...
        <section className='grid grid-cols-3 grid-rows-9 gap-4 m-8'>
          <div className={`row-span-2 w-full h-full bg-[url(./assets/bg.svg)] bg-cover bg-center rounded-md ${hover}`}>
          </div>
          <div className={`w-full h-64 bg-[url(./assets/bg.svg)] bg-cover bg-center rounded-md ${hover}`}>
          </div>
          <div className={`w-full h-64 bg-[url(./assets/bg.svg)] bg-cover bg-center rounded-md ${hover}`}>
          </div>
          <div className={`row-span-2 w-full h-full bg-[url(./assets/bg.svg)] bg-cover bg-center rounded-md ${hover}`}>
